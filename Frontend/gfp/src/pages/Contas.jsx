...
import { MdAdd, MdEdit, MdDelete, MdCreditCard, MdAccountBalance, MdEmail, MdFeaturedPlayList, MdAttachMoney, MdAutoGraph, MdAccountBalanceWallet } from 'react-icons/md';
...
export default function Contas() {
    ...
    const iconesTipoConta = {
        'CONTA_CORRENTE' : <MdAccountBalanceWallet className='h-6 w-6'/>,
    ...
    const exibirItemLista = (item) => {
        return (
            <div key={item.id_conta} className={Estilos.linhaListagem}>
                <div className='p-2 bg-cyan-100 text-cyan-600 rounded-full'>{iconesTipoConta[item.tipo_conta]}
