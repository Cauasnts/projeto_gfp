...
import { View, Text, FlatList, TouchableOpacity, RefreshControl, Modal, TextInput, Button, Alert } from 'react-native';
import { MaterialIcons } from '@expo/vector-icons';
import AsyncStorage from '@react-native-async-storage/async-storage';
import Estilos, { corPrincipal } from '../styles/Estilos';
import { enderecoServidor, listaIcones, listaCores } from '../utils';
...
export default function Categorias({ navigation }) {
    ...
    const confirmarExclusao = (id) => {
        Alert.alert(
            ...
            [
                ...
                { text: 'Excluir', style: 'destructive', onPress: () => excluirCategoria(id) }
            ]
        );
    };
    ...
    const exibirItemLista = ({ item }) => (
        <TouchableOpacity style={Estilos.itemLista}>
            ...
            <MaterialIcons name="delete" size={24} color={corPrincipal} onPress={() => confirmarExclusao(item.id_categoria)} />
        </TouchableOpacity>
    );
    ...
    return (
        <View style={Estilos.conteudoHeader}>
            ...
            <Modal visible={modalVisible} transparent={true} animationType="slide" onRequestClose={() => setModalVisible(false)}>
                <View style={Estilos.modalFundo}>
                    <View style={Estilos.modalConteudo}>
                        ...
                        <Text style={Estilos.textoBotaoModal}>Cor</Text>
            ...
            <Modal visible={corModalVisible} transparent={true} animationType="slide" onRequestClose={() => setCorModalVisible(false)}>
                <View style={Estilos.modalFundo}>
            ...
            <Modal visible={iconeModalVisible} transparent={true} animationType="slide" onRequestClose={() => setIconeModalVisible(false)}>
                <View style={Estilos.modalFundo}>
                    <View style={Estilos.SeletorContainer}>
